...
const BOT_NAME = process.env.BOT_NAME ?? "Z Bot";
    ...
    if (setting.autoAI) {
      if (budy) {
        try {
          ...
          console.log(err);
          m.reply(
            "I am getting API Update right now. Please hold on anc check back in a while."
          );
        }
      }
    }
